...
// ── State ──
let correct = parseInt(localStorage.getItem("kanaCorrect")) || 0;
let wrong = parseInt(localStorage.getItem("kanaWrong")) || 0;
let currentIndex = Math.floor(Math.random() * kana.length);
...
form.addEventListener("submit", function (event) {
  ...
  wrongEl.textContent = wrong;
  totalEl.textContent = correct + wrong;
  localStorage.setItem("kanaCorrect", correct);
  localStorage.setItem("kanaWrong", wrong);
...
resetBtn.addEventListener("click", function () {
  if (confirm("Are you sure you want to reset your tally?")) {
    correct = 0;
    wrong = 0;
    localStorage.removeItem("kanaCorrect");
    localStorage.removeItem("kanaWrong");
